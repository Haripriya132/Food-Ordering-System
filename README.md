...
CraveHive is a simple, client-side food ordering system with a C++ console backend, a browser-based frontend, and a PostgreSQL (Supabase) schema designed for future database migration.
